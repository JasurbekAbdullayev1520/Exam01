...
- [60, 69]: `"D (Qoniqarsiz)"`
- [0, 59]: `"F (Yomon)"`
- Aks xolatda: `alig'ida bo'lishi kerak!"`
...
**🧮 Vazifa:** Foydalanuvchi kiritgan `N` sonigacha bo‘lgan barcha sonlarning yig‘indisini for loop yordamida hisoblang."Ball 0-100 or
**📥 Kirish:** `N = 5`
